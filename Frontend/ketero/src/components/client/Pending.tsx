  ...
  return (
    <div className={style.reservationCard}>
      ...
      <div className={style.reservationCardRow3}>
        <div className={style.cardBottomItem}>{reservation.time}</div>
        <div className={style.cardBottomItem}>{reservation.phone}</div>
        <div className={style.cardBottomItem}>{reservation.payment}</div>
      </div>
