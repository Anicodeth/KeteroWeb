const { createClient, createBusiness, createMezgeb, loginUser } = require('../services/authService');
...
exports.createBusiness = async (req, res) => {
  try {
    ...
    const business = await createBusiness({ ownerName, businessName, email, password });
